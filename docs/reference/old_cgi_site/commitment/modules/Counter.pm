package Counter; # Counter name space
require 5.004;

use Persistent::File; # File-based object cache
use strict; # Full scoping required, among other things.
use Carp;
@Counter::ISA = qw(Persistent::File);
# Counter::initialize() - Automatically called by new()
#
sub initialize {
    my $this = shift;
    ...
    $this->add_attribute('val', 'persist', 'Number', undef, 8, 0);
}
